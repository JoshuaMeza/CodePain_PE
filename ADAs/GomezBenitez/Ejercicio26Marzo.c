...
void imprimirSeccion2a4(int arreglo[][N]);
void imprimirSeccion1a3(int arreglo[][N]);
int main () {
   int arreglo[N][N];
   time_t t;
   ...
   imprimirSeccion2a4(arreglo);
   imprimirSeccion1a3(arreglo);
   return(0);
}
...
//Imprime las secciones 2 y 4, de tal forma que sea la representación visual de la misma
void imprimirSeccion2a4(int arreglo[][N]){
    for (int i=0; i<N; i++){
        for ( int j=0;j<N; j++){
            if (i>=0){
...
//Imprime las secciones 1 y 3, de tal forma que sea la representación visual de la misma
void imprimirSeccion1a3(int arreglo[][N]){
    for (int i=0; i<N; i++){
        for ( int j=0;j<N; j++){
            if (i>=0){
